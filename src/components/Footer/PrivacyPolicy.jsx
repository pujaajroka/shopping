...
const PrivacyPolicy = () => {
  return (
    <div className="peiv_container">
      <Navbar />
      <div className="priv_policy">
        <h1 className="privacy_pol">PRIVACY & POLICY</h1> <br />
        <p className="about_privacy">
        ...
        <h4 className="about_privacy">Collection of Your Information</h4>
        <p className="about_privacy">
        ...
        <h4 className="about_privacy">Security</h4>
        <p className="about_privacy">
        ...
        <h4 className="about_privacy">CHANGES TO THIS POLICY</h4>
        <p className="about_privacy">
        ...
        <h4 className="about_privacy">HOW TO CONTACT US</h4>
        <p className="about_privacy">
